...
export default function EditWorkOrderPage() {
  ...
  useEffect(() => {
    if (workOrder) {
      ...
      setProjectId(workOrder.projectId || null);
      setAssetId(workOrder.assetId || null);
      setLocation(workOrder.location || null);
      setAssignedTeam(workOrder.assignedTeam || null);
      setAssignedTo(workOrder.assignedTo || null);
      setDueDate(workOrder.dueDate ? new Date(workOrder.dueDate) : undefined);
      setStartDate(workOrder.startDate ? new Date(workOrder.startDate) : undefined);
      setCompletedDate(workOrder.completedDate ? new Date(workOrder.completedDate) : undefined);
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="mb-6">
        <Button variant="outline" size="sm" onClick={() => router.push(`/workorders/${workOrderId}`)}>
