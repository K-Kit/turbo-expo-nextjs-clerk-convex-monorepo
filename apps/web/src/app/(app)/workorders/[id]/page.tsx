...
const WorkOrderTaskForm = ({ workOrderId, onTaskAdded }: WorkOrderTaskFormProps) => {
                ...
                <div className="flex mb-2 items-center justify-between">
                  ...
                  {workOrder.completedDate && (
                    <div className="text-xs text-gray-500">
                      Completed {formatDistanceToNow(workOrder.completedDate)} ago
                    </div>
                  )}
                </div>
              ...
              {workOrder.startDate && (
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{format(workOrder.startDate, 'PPP')}</p>
                  </div>
                </div>
              )}
              ...
              {workOrder.dueDate && (
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{format(workOrder.dueDate, 'PPP')}</p>
                  </div>
                </div>
              )}
              ...
              {workOrder.estimatedHours && (
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{workOrder.estimatedHours} hours</p>
                  </div>
                </div>
              )}
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <Link href={`/projects/${project._id}`}>
                      <p className="text-sm text-blue-500 hover:underline">{project.name}</p>
                    </Link>
                  </div>
                </div>
              )}
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <Link href={`/assets/${asset._id}`}>
                      <p className="text-sm text-blue-500 hover:underline">{asset.name}</p>
                    </Link>
                  </div>
                </div>
              )}
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      {workOrder.location.lat.toFixed(6)}, {workOrder.location.lng.toFixed(6)}
                    </p>
                  </div>
                </div>
              )}
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="comments" className="mt-6">
          <div className="space-y-6">
            <CommentForm 
              workOrderId={workOrderId} 
              onCommentAdded={() => setUpdateCommentsTrigger(prev => prev + 1)} 
            />
