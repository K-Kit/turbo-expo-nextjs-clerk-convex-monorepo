...
export default function WorksiteDetail() {
  ...
  const worksiteUsers = useQuery(api.worksites.listWorksiteUsers, {
    worksiteId: worksiteId as Id<"worksites">,
  });
  const tenantUsers = useQuery(api.users.listByTenant, {
    tenantId: worksite?.tenantId as Id<"tenants">,
  });
  ...
  const handleDelete = async () => {
    try {
      ...
      setError(
        err instanceof Error ? err.message : "Failed to delete worksite",
      );
      setIsDeleting(false);
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
          ...
          <div className="bg-white shadow sm:rounded-lg p-6 text-center">
            ...
            <p className="mt-1 text-sm text-gray-500">
              The worksite you're looking for doesn't exist or you don't have
              access to it.
            </p>
            <div className="mt-6">
              <Link
    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
          ...
          <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded-lg shadow-xl max-w-md w-full">
              ...
              <p className="mt-2 text-sm text-gray-500">
                Are you sure you want to delete this worksite? This action
                cannot be undone.
              </p>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                ...
                <div className="sm:col-span-6">
                  ...
                  <dd className="mt-1 text-sm text-gray-900">
                    Latitude: {worksite.coordinates.latitude}, Longitude:{" "}
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg p-4 mt-4 display:none">
            <MapView
          ...
          <div className="px-4 py-5 sm:p-6">
            ...
            {worksiteUsers && worksiteUsers.length > 0 ? (
              ...
              <div className="bg-gray-50 text-center py-10 rounded-md">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  No users assigned to this worksite yet
                </p>
              </div>
            )}
                  ...
                  <form onSubmit={handleAddUser} className="mt-4">
                    <div className="mb-4">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setSelectedUserId(e.target.value as Id<"users">)
                        }
                        className="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                      >
            ...
            {userToRemove && (
              <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
                <div className="bg-white p-6 rounded-lg shadow-xl max-w-md w-full">
                  ...
                  <p className="mt-2 text-sm text-gray-500">
                    Are you sure you want to remove this user from the worksite?
